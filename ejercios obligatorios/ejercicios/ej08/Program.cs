    ...
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                {
                    Console.WriteLine("Bienvenido, hay "+ alumnosPresentes+" alumnos presentes (mas del 50%) y el profesor esta presente, se puede iniciar la clase");
                    break;
                }
                else if (alumnosPresentes > aula.MaxEstudiantes / 2)
                    Console.WriteLine("Bienvenido, hay " + alumnosPresentes+" alumnos presentes (mas del 50%), pero el profesor no esta, y no se puede iniciar la clase");
                else
                    Console.WriteLine("Bienvenido, hay "+ alumnosPresentes + " alumnos presentes (menos del 50%) y el profesor no esta, por lo tanto no se puede iniciar la clase");
                Console.WriteLine("\n\nPresione cualquier letra para reiniciar el día...");
                Console.ReadKey();
            }
            Console.WriteLine("\nLa cantidad de chicos aprobados son " + aula.Chicosaprobados()+" y las chicas aprobadas son "+ aula.Chicasaprobados());
