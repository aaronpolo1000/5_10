    ...
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                string idbebida = Console.ReadLine();
                if (Int32.TryParse(idbebida, out id)) break;
            }
            Console.WriteLine(almacen.eliminarBebida(id));
            ...
            while (true)
            {
                ...
                else if (key.Key == ConsoleKey.D1) break;
            }
            while (true)
            {
                Console.Clear();
                ...
                if (opcion == 1)
                {
                    ...
                    ConsoleKeyInfo key = Console.ReadKey();
                    int idmarca = Convert.ToInt32(key.Key) - Convert.ToInt32(ConsoleKey.D0);
                    if (idmarca - 1 < Marcasa.Count() && Marcasa.Contains(Marcasa[idmarca - 1]))
                    {
                        marca = Marcasa[idmarca - 1];
                        break;
                    }
                }
                else
                {
                    ...
                    ConsoleKeyInfo key = Console.ReadKey();
                    int idmarca = Convert.ToInt32(key.Key) - Convert.ToInt32(ConsoleKey.D0);
                    if (idmarca - 1 < Marcasb.Count() && Marcasb.Contains(Marcasb[idmarca - 1]))
                    {
                        marca = Marcasb[idmarca - 1];
                        break;
                    }
                }
            }
            ...
            int vi = Convert.ToInt32(keys.Key) - Convert.ToInt32(ConsoleKey.D0);
